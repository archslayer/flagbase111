...
export interface AchievementsInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface Achievements extends BaseContract {
  connect(runner?: ContractRunner | null): Achievements;
